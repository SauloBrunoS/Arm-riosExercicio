...
pegarCodigo indice armarios = case pegarArmario indice armarios of
                              Left _ -> Left $ Either.fromLeft "Erro" (pegarArmario indice armarios)
...
aluguel indice armarios = case pegarCodigo indice armarios of
                          Left _ -> Left $ Either.fromLeft "Erro" (pegarCodigo indice armarios)
...
devolucao indice codigo armarios =  case pegarArmario indice armarios of
                          Left _ -> Left $ Either.fromLeft "Erro" (pegarArmario indice armarios)
                          Right (estado, codigoreal) -> if estado /= Alugado
                                                      then Left "Armario nao esta alugado"
                                                      else if codigoreal /= codigo
